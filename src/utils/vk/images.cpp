...
void vkimage::transitionImage(VkCommandBuffer cmd, VkImage image,
...
void vkimage::copyImage(VkCommandBuffer cmd, VkImage src, VkImage dst,
...
void vkimage::generateMipmap(VkCommandBuffer cmd, VkImage image,
